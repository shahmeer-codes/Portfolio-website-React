    ...
    <div className="min-h-screen bg-black text-white flex justify-around items-center px-8 md:px-20">
      <div className="max-w-4xl">
        ...
        <p className="text-gray-400 text-lg leading-relaxed max-w-3xl">
          ...
          React, Node.js, Express, MongoDB, Redux Toolkit, and TypeScript.
          My focus is on creating clean, efficient, and high-performance
          digital solutions that provide exceptional user experiences and
          solve real-world problems.
        </p>
      </div>
      <div>
        <img src="/path/to/your/image.jpg" alt="Your Name" className="w-90 h-90 object-cover rounded-full border-4 border-green-400" />
      </div>
    </div>
  );
};
